...
<script type="text/javascript">
          ...
          document.getElementById('uyari').innerHTML="Aynı ada sahip dosya var! Yönlediriliyorsunuz...";
            saniye --;
            if(saniye >0){
...
if ($_POST) {
  if (isset($_POST["newfile"]) and $_POST["newfile"]!="") {
     $link="upload/".$_POST["gt"].duzenle($_POST["newfile"]).$_POST["fileextention"];
    if (file_exists("upload/".$_POST["gt"].duzenle($_POST["newfile"]).$_POST["fileextention"])) {
      ?>
        <div class="kapsam">
          <div id="saniye"></div>
          <div id="uyari"></div>          
